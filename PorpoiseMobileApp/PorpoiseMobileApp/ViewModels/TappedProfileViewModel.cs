...
{
    public class TappedProfileViewModel : SrendipViewModel<TappedProfileViewModel>
    {
        public TappedProfileViewModel()
        {
        }
        ...
        public TappedProfileViewModel(IPorpoiseWebApiClient client, ISettings settings, IEncryptionService encryption)
        {
            this.client = client;
