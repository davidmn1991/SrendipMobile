...
{
    public partial class TappedProfileViewController : MvvmViewController<TappedProfileViewModel>
    {
        public TappedProfileViewController (IntPtr handle) : base (handle)
        {
        }
