...
{
    public partial class BiggestPetPeeveViewController : MvvmViewController<BiggestPetPeeveViewModel>
    {
        public BiggestPetPeeveViewController(IntPtr handle) : base(handle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            biggets_petlbl.TextColor = UIColor.FromRGB(112, 112, 112);
            ...
            biggets_petlbl.AddGestureRecognizer(GoBack);

            biggets_petlbl.UserInteractionEnabled = true;

            biggestpetPevee_textView.Layer.BorderColor = UIColor.Black.CGColor;

            biggestpetPevee_textView.Layer.BorderWidth = 1f;
            ...
            addBubble_button.TouchUpInside += delegate
            {
                ...
                ViewModel.description = biggestpetPevee_textView.Text;
